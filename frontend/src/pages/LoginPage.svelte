...
<section class="min-h-[calc(100vh-200px)] flex items-center justify-center px-6 py-16">
	<div class="w-full max-w-md">
		<!-- Login Card -->
		<div class="border border-mist bg-white p-8 shadow-sm">
			<!-- Header -->
			...
			<!-- Error Message -->
			{#if error}
				<div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-sm flex items-start gap-3" role="alert">
				...
				<div class="space-y-2">
					...
					<div class="relative">
						...
						<input
							...
							required
							autocomplete="email"
							class="w-full pl-10 pr-4 py-3 border-b-2 border-mist bg-transparent text-ink placeholder:text-stone/60 focus:border-coral focus:outline-none transition-colors"
						/>
					</div>
				</div>
				...
				<div class="space-y-2">
					...
					<div class="relative">
						...
						<input
							...
							class="w-full pl-10 pr-12 py-3 border-b-2 border-mist bg-transparent text-ink placeholder:text-stone/60 focus:border-coral focus:outline-none transition-colors"
						/>
						<button
							type="button"
							onclick={togglePassword}
							class="absolute right-0 top-0 bottom-0 flex items-center pr-3 text-stone hover:text-ink transition-colors"
