...
{:else}
  <a
    ...
    href={loginUrl}
    class={isDesktop
      ? `${sharedClass} hover:border-stone-300 hover:bg-mist/40 min-h-[3.25rem] text-ink dark:hover:border-slate-600 dark:hover:bg-slate-800`
      : `${sharedClass} hover:border-stone-300 hover:bg-mist/40 min-h-14 text-ink dark:hover:border-slate-600 dark:hover:bg-slate-800`}
    onclick={onNavigate}
  >
