    ...
    <div id={menuId}>
      ...
      >
        <div class="space-y-4 pb-4">
          <div class="bg-mist/35 rounded-lg px-4 py-4 dark:bg-slate-800/60">
            <div
              class="mb-3 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-stone dark:text-slate-400"
            >
              <Palette size={14} />
              Theme
            </div>
